        ...
        <section id="hero" className="py-20 sm:py-32">
          <div className="container px-4 md:px-6 text-center flex flex-col items-center">
             ...
             <p className="mt-6 max-w-2xl mx-auto text-lg text-muted-foreground md:text-xl">
                Reverse search with an image, URL, or text to find what you're looking for across the web's top image search engines.
             </p>
                    ...
                    <CardContent className="p-4 sm:p-6 space-y-6">
                      ...
                      {searchQuery && !imagePreview && (
                        <div className="p-6 text-center">
                          <p className="text-lg font-medium text-foreground">Searching for: <span className="font-bold text-primary">{searchQuery}</span></p>
                        </div>
                      )}
                          ...
                          {searchEngines.map((engine) => {
                            ...
                            return (
                                <Button 
                                  ...
                                  disabled={isLoading || (!imageUrl && !searchQuery) || (searchQuery && !engine.textSearchUrl && !isQueryImageUrl) || (imageUrl && !engine.url)}
                                  onClick={() => handleSearch(engine)}
                                >
                                  {IconComponent && <IconComponent className="h-6 w-6 text-foreground transition-transform duration-300 group-hover:scale-110" />}
                      ...
                      <Button variant="ghost" onClick={resetState} className="w-full text-primary hover:bg-primary/10 hover:text-primary">
            ...
            <div className="container px-4 md:px-6">
                ...
                <div className="mt-16 grid gap-12 md:grid-cols-3">
                    <div className="text-center flex flex-col items-center">
                        ...
                        <p className="mt-2 text-muted-foreground max-w-xs mx-auto">Drag and drop an image, paste a URL, or type a description in the search box.</p>
                    </div>
                     <div className="text-center flex flex-col items-center">
                        <div className="flex items-center justify-center h-16 w-16 rounded-full bg-primary text-primary-foreground mx-auto mb-6 shadow-lg shadow-primary/30">
                        ...
                        <p className="mt-2 text-muted-foreground max-w-xs mx-auto">For images, a temporary, secure link is generated for the search.</p>
                    </div>
                     <div className="text-center flex flex-col items-center">
                        <div className="flex items-center justify-center h-16 w-16 rounded-full bg-primary text-primary-foreground mx-auto mb-6 shadow-lg shadow-primary/30">
                        ...
                        <p className="mt-2 text-muted-foreground max-w-xs mx-auto">Click your preferred search engine to see the results in a new tab.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="features" className="py-20 sm:py-24">
            <div className="container px-4 md:px-6">
                <div className="text-center max-w-2xl mx-auto">
                     ...
                     <p className="mt-4 text-lg text-muted-foreground">Everything you need for a quick and private image search.</p>
                </div>
        ...
        <section id="testimonials" className="py-20 sm:py-24 bg-muted/50">
          <div className="container px-4 md:px-6">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="mt-4 text-lg text-muted-foreground">Join thousands of satisfied users who find images faster with Image Dash.</p>
            </div>
